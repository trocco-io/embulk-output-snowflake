...
public class JdbcOutputPlugin extends AbstractJdbcOutputPlugin {
  ...
  @Override
  protected GenericOutputConnector getConnector(
    ...
    return new GenericOutputConnector(
        t.getUrl(), props, t.getDriverClass(), t.getSchema().orElse(null));
  }

  private static class GenericOutputConnector implements JdbcOutputConnector {
    private final Driver driver;
    private final String url;
    private final Properties properties;
    private final String schemaName;

    public GenericOutputConnector(
        String url, Properties properties, String driverClass, String schemaName) {
      try {

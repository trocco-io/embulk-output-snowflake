        ...
        extends AbstractJdbcOutputPlugin
{
    ...
    protected Features getFeatures(PluginTask task)
    {
        return new Features()
                ...
                .setSupportedModes(new HashSet<>(Arrays.asList(Mode.INSERT, Mode.INSERT_DIRECT, Mode.TRUNCATE_INSERT, Mode.REPLACE)))
                           ...
                           PluginTask task, final Schema schema, int taskCount) throws SQLException
    {
        ...
        if (!mode.isDirectModify()) {
            ...
            if (task.getBeforeLoad().isPresent()) {
                SnowflakeOutputConnection sc = (SnowflakeOutputConnection) con;
                sc.executeSql(task.getBeforeLoad().get());
            }
        }

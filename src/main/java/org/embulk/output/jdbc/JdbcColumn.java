...
public class JdbcColumn {
  ...
  public static JdbcColumn newGenericTypeColumn(
      String name,
      int sqlType,
      String simpleTypeName,
      int sizeTypeParameter,
      int scaleTypeParameter,
      int dataLength,
      boolean isNotNull,
      boolean isUniqueKey) {
  ...
  public static JdbcColumn newTypeDeclaredColumn(
      String name, int sqlType, String declaredType, boolean isNotNull, boolean isUniqueKey) {
    return new JdbcColumn(
        name, sqlType, declaredType, 0, 0, 0, Optional.of(declaredType), isNotNull, isUniqueKey);
  }

...
public class StandardBatchInsert implements BatchInsert {
  ...
  public StandardBatchInsert(JdbcOutputConnector connector, Optional<MergeConfig> mergeConfig)
  ...
  protected PreparedStatement prepareStatement(TableIdentifier loadTable, JdbcSchema insertSchema)
      throws SQLException {
  ...
  public void flush() throws IOException, SQLException {
    ...
    try {
      lastUpdateCounts =
          batch.executeBatch(); // here can't use returned value because MySQL Connector/J returns
      // SUCCESS_NO_INFO as a batch result
  ...
  public void setSqlDate(final Instant v, final Calendar cal) throws IOException, SQLException {
    ...
    // milliseconds to zero in the particular time zone with which the instance is associated.
  ...
  public void setSqlTimestamp(final Instant v, final Calendar cal)
      throws IOException, SQLException {

...
public class BigDecimalColumnSetter extends ColumnSetter {
  private static final BigDecimal ZERO = BigDecimal.valueOf(0L);
  private static final BigDecimal ONE = BigDecimal.valueOf(1L);

  public BigDecimalColumnSetter(
      BatchInsert batch, JdbcColumn column, DefaultValueSetter defaultValue) {
